...
- heading + bullets 또는 circles 또는 infographic
...
- 우측 배치 — bullets/infographic 3개 이상: 350~600자

### bullets/circles/infographic 나레이션 작성 원칙
...
narration: "영화 속 인물들과 그들의 직업적 관계를 분석하면서, 여러분 자신의 진로 목표를 구체화하고, 진로를 선택할 때 부딪히는 어려운 점들을 함께 탐색해 나가는 수업입니다. #1 이번 주차 강의에서는 여러분이 가졌던 직업에 대한 고정관념을 조금 깨드리고 싶습니다. #2 우리가 영화를 통해 진로를 탐색하는 세 가지 방법입니다."
...
- 금지: "#1 #2" 연속 배치 — 각 마커 사이에 반드시 1문장 이상 삽입
...
- 전환 효과: 페이드인, 슬라이드인, 팝업
예: "강사 우측 배치. 좌측에 데이터 아이콘 3개(성장 화살표, 체크리스트, 연결망) 순서대로 등장."
  ...
  "pages": [
    {
      ...
      "chapter_index": 0,
      "item_index": 0,
      "screen_desc": "강사 중앙 배치. 어두운 배경 그라데이션. 질문 텍스트 크게 중앙 표시.",
      "slide": {
      ...
      "narration": "강사 나레이션 200~300자. #1 heading 등장. 본문 설명. #2 bullets 등장 직전. 마무리."
    }
  ],
  "index": [
    {
...
- elements 수는 나레이션 분량에 비례
- bullets 5개 + 나레이션 150자는 절대 금지

## #마커 규칙
- heading: 나레이션 시작 직후 #1
- bullets/circles: 전체 등장 직전 마커 1개 (items 수와 무관)
